...
let firstHonda = inventory.filter(car => car.car_make == "Honda")

    console.log(firstHonda);
    console.log(`this is ${firstHonda.car_make}`)
// this doesn't work,
/*
Part II
...
let newOrder = inventory.map((car) => car.car_year);
let fertigeOrdnung = newOrder.sort()
console.log(fertigeOrdnung)
